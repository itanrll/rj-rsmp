                        ...
                        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('image/assets/img/jm_denis.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('image/assets/img/chadengle.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('image/assets/img/mlane.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('image/assets/img/talha.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                    ...
                                    <li>
                                        <div class="notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('image/assets/img/profile2.jpg') }}"
                                                            alt="Img Profile" />
                                                    </div>
                                                    <div class="notif-content">
                                                        <span class="block">
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                                    aria-expanded="false">
                                    <div class="avatar-sm">
                                        <img src="{{ asset('image/assets/img/profile.jpg') }}" alt="..."
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        <li>
                                            <div class="user-box">
                                                <div class="avatar-lg">
                                                    <img src="{{ asset('image/assets/img/profile.jpg') }}"
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('image/assets/img/flags/id.png') }}"
                                      alt="indonesia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('image/assets/img/flags/us.png') }}"
                                      alt="united states"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('image/assets/img/flags/au.png') }}"
                                      alt="australia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('image/assets/img/flags/ru.png') }}"
                                      alt="russia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('image/assets/img/flags/cn.png') }}"
                                      alt="china"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="{{ asset('image/assets/img/flags/br.png') }}"
                                      alt="brazil"
                                    />
                                  </div>
                                </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="card-list py-4">
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="{{ asset('image/assets/img/jm_denis.jpg') }}"
                            alt="..."
                            class="avatar-img rounded-circle"
                          />
                        </div>
                      ...
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="{{ asset('image/assets/img/talha.jpg') }}"
                            alt="..."
                            class="avatar-img rounded-circle"
                          />
                        </div>
                      ...
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="{{ asset('image/assets/img/chadengle.jpg' ) }}"
                            alt="..."
                            class="avatar-img rounded-circle"
                          />
                        </div>
