              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('image/assets/img/mlane.jpg') }}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                      ...
                      <div class="notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('image/assets/img/profile2.jpg') }}"
                                alt="Img Profile"
                              />
                            </div>
                            <div class="notif-content">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="{{ asset('image/assets/img/profile.jpg') }}"
                        alt="..."
                      ...
                      <table class="table align-items-center mb-0">
                        <thead class="thead-light">
                          <tr>
                            ...
                            <th scope="col" class="text-end">Spesialis</th>
                            <th scope="col" class="text-end">Alamat</th>
                            <th scope="col" class="text-end">SIP</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="{{ route('dokter.destroy', $item->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="btn btn-icon btn-danger delete-btn" type="button">
